...
@interface XXYActionSheetView ()<UITableViewDataSource, UITableViewDelegate>
{
...
@implementation XXYActionSheetView
//
- (instancetype)initWithTitle:(NSString *)title delegate:(id<XXYActionSheetViewDelegate>)actionSheetViewDelegate cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ...{
    self = [super init];
    if (self) {
        ...
        //
        [self xxy_setupXXYActionSheetViewSubviews];
    }
    return self;
}
...
- (void)xxy_setupXXYActionSheetViewSubviews{
...
- (UITableView *)tableView {
    if (_tableView == nil) {
        ...
        [_tableView setBackgroundColor:XXYColor(0.0, 0.0, 0.0, 1.0)];
...
- (UIButton *)cancelButton {
    if (_cancelButton == nil) {
        ...
        [_cancelButton setBackgroundImage:[UIImage xxy_imageWithColor:[UIColor colorWithWhite:0.5 alpha:0.3]] forState:UIControlStateHighlighted];
    }
