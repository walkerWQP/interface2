...
- (void)showViewWithSuperView:(UIView *)superView {
    ...
    self.showBgView = [[EasyShowTextBgView alloc]initWithFrame:showFrame status:self.showTextStatus text:self.showText imageName:self.showImageName];
    ...
    switch (self.options.textStatusType) {
        ...
        default:{
            ...
            if (!ISEMPTY_S(self.showText)) {
                textSize = [EasyShowUtils textWidthWithStirng:self.showText font:self.options.textTitleFount maxWidth:TextShowMaxWidth];
            }
