...
- (void)makeBindMobilePhoneViewControllerUI {
    ...
    self.phoneLabel = [[UILabel alloc] initWithFrame:CGRectMake(50 + self.phoneImgView.frame.size.width, 40, 50, 20)];
    ...
    self.verLabel = [[UILabel alloc] initWithFrame:CGRectMake(50 + self.verImgView.frame.size.width, 80 + self.phoneLabel.frame.size.height + self.phoneTextField.frame.size.height, 50, 20)];
